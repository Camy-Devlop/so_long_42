...
void initialiserLabyrinthe(char labyrinthe[TAILLE][TAILLE2]) {
    for (int i = 0; i < TAILLE; i++) {
        for (int j = 0; j < TAILLE2; j++) {
            if (i == 0 || i == TAILLE - 1 || j == 0 || j == TAILLE2 - 1) {
...
void placerElement(char labyrinthe[TAILLE][TAILLE2], char element) {
    int x, y;
    do {
...
void afficherLabyrinthe(char labyrinthe[TAILLE][TAILLE2]) {
    for (int i = 0; i < TAILLE; i++) {
        for (int j = 0; j < TAILLE2; j++) {
...
int main() {
    ...
    char labyrinthe[TAILLE][TAILLE2];
